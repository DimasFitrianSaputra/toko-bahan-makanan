            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div class="space-y-2">
                    <div class="rounded-lg bg-slate-50 px-3 py-3 border border-slate-200">
                        ...
                        <div class="mt-1 text-sm font-semibold text-slate-900">Toko Bahan Makanan</div>
                    </div>
                    <div class="rounded-lg bg-slate-50 px-3 py-3 border border-slate-200">
                        <div class="text-xs font-medium text-slate-600 uppercase tracking-wider">Jam Operasional</div>
                        <div class="mt-1 text-sm font-semibold text-slate-900">Senin - Minggu: 08:00 - 20:00</div>
                    </div>
                </div>
            </div>
