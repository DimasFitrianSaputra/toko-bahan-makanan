    ...
    <div class="space-y-4 md:space-y-6 pt-4 md:pt-6 w-full">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow duration-200 hover:shadow">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-slate-500">Barang inventori</p>
                    </div>
                    <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-100">
                        <svg class="h-5 w-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m0 0l8-4m0 0l8 4M4 7v10a1 1 0 001 1h14a1 1 0 001-1V7m-8-4v4"></path></svg>
                    </div>
                </div>
            </div>
        ...
        <div class="grid gap-4 lg:grid-cols-2">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div class="space-y-2">
                    <a href="{{ route('products.index') }}" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 transition hover:bg-emerald-50 hover:border-emerald-200">
                        <svg class="h-4 w-4 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m0 0l8-4m0 0l8 4M4 7v10a1 1 0 001 1h14a1 1 0 001-1V7m-8-4v4"></path></svg>
                        <div class="flex-1">
                    ...
                    <a href="{{ route('stok.index') }}" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 transition hover:bg-emerald-50 hover:border-emerald-200">
                        <svg class="h-4 w-4 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7h18M7 11h10M9 15h6M6 5v14a2 2 0 002 2h8a2 2 0 002-2V5M6 5h12"></path></svg>
                        <div class="flex-1">
