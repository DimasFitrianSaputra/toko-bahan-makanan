                ...
                <div class="border-b border-slate-200 p-6 md:p-8">
                    <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:gap-8 items-center lg:items-start text-center lg:text-left">
                        ...
                        <div class="relative">
                            ...
                            <template x-if="!hasPhoto">
                                <div class="flex h-28 w-28 items-center justify-center rounded-2xl border-4 border-emerald-100 bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-md">
                            ...
                            @if(Auth::user()->role === 'admin')
                                <button type="button" onclick="document.getElementById('profile_photo_upload').click();" class="absolute bottom-0 right-0 flex h-8 w-8 items-center justify-center rounded-full border-2 border-white bg-emerald-600 text-white shadow-md hover:bg-emerald-500">
                            ...
                            <div>
                                ...
                                <div class="mt-3 flex flex-col sm:flex-row items-center gap-4">
                                    <div id="photoUploadBox" class="flex-1">
                                        <label for="profile_photo" class="flex cursor-pointer items-center gap-3 rounded-xl border-2 border-dashed border-slate-300 px-6 py-6 transition hover:border-emerald-400 hover:bg-emerald-50">
                                        ...
                                        <p id="photoFileName" class="mt-2 text-sm text-emerald-600"></p>
                                    </div>
