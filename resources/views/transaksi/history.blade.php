                    ...
                    @forelse($transactions as $transaction)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                <a href="{{ route('transaksi.show', $transaction) }}" class="inline-flex items-center rounded-3xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">Detail</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
